    ...
    , ui(new Ui::MainWindow)
{
    ...
    */
     ...
     */
    connect(accessWin, &DBAccess::sig_sendData, this, [&](QVector<QString> receivData){
    ...
    connect(this, &MainWindow::sig_table_clear, dataBase, &DataBase::table_clear);
}
...
void MainWindow::on_pb_request_clicked()
{
    ...
    emit sig_RequestToDb(ui->tableView, ui->cb_category->currentText());
...
{
    emit sig_table_clear(ui->tableView);
}

...
public:
    ...
    virtual void print_info(Figura* ukazatel) {
        ...
        std::cout << "Количество сторон: " << storony << "\n";
...
public:
    ...
    void print_info(Figura* ukazatel) override {
        ...
        if (ugol_A + ugol_B + ugol_C == 180 && ugol_C == 90)
            std::cout << "Правильная \n";
        else
            std::cout << "Неправильная \n";
        std::cout << "Количество сторон: " << storony << "\n";
...
public:
    ...
    void print_info(Figura* ukazatel) override {
        ...
        if (ugol_A + ugol_B + ugol_C == 180 && dlina_a == dlina_c && ugol_A == ugol_C)
            std::cout << "Правильная \n";
        else
            std::cout << "Неправильная \n";
        std::cout << "Количество сторон: " << storony << "\n";
...
public:
    ...
    void print_info(Figura* ukazatel) override {
        ...
        if (ugol_A == 60 && ugol_A == ugol_B && ugol_B == ugol_C && dlina_a == dlina_b && dlina_b == dlina_c)
            std::cout << "Правильная \n";
        else
            std::cout << "Неправильная \n";
        std::cout << "Количество сторон: " << storony << "\n";
...
public:
    ...
    void print_info(Figura* ukazatel) override {
        ...
        if (ugol_A + ugol_B + ugol_C + ugol_D == 360)
            std::cout << "Правильная \n";
        else
            std::cout << "Неправильная \n";
        std::cout << "Количество сторон: " << storony << "\n";
...
public:
    ...
    void print_info(Figura* ukazatel) override {
        ...
        if (ugol_A == 90 && ugol_B == 90 &&  ugol_C == 90 && ugol_D == 90 && dlina_a == dlina_c && dlina_b == dlina_d)
            std::cout << "Правильная \n";
        else
            std::cout << "Неправильная \n";
        std::cout << "Количество сторон: " << storony << "\n";
...
public:
    ...
    void print_info(Figura* ukazatel) override {
        std::cout << "Квадрат: \n";
        if (ugol_A == 90 && ugol_B == 90 && ugol_C == 90 && ugol_D == 90 && dlina_a == dlina_b && dlina_b == dlina_c && dlina_c == dlina_d)
            std::cout << "Правильная \n";
        else
            std::cout << "Неправильная \n";
        std::cout << "Количество сторон: " << storony << "\n";
...
public:
    ...
    void print_info(Figura* ukazatel) override {
        ...
        if (ugol_A + ugol_B + ugol_C + ugol_D == 360 && ugol_A == ugol_C && ugol_B == ugol_D && dlina_a == dlina_c && dlina_b == dlina_d)
            std::cout << "Правильная \n";
        else
            std::cout << "Неправильная \n";
        std::cout << "Количество сторон: " << storony << "\n";
...
public:
    ...
    void print_info(Figura* ukazatel) override {
        std::cout << "Ромб: \n";
        if (ugol_A + ugol_B + ugol_C + ugol_D == 360 && ugol_A == ugol_C && ugol_B == ugol_D && dlina_a == dlina_b && dlina_b == dlina_c && dlina_c == dlina_d)
            std::cout << "Правильная \n";
        else
            std::cout << "Неправильная \n";
        std::cout << "Количество сторон: " << storony << "\n";
